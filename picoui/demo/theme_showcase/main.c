...
static void apply_theme(struct picoui_theme *theme,
                        ...
                        struct picoui_text *body,
                        struct picoui_button *accent)
{
    if (theme == 0 || window == 0 || title == 0 || body == 0 || accent == 0) {
        return;
    }
...
static void make_ui(struct picoui_window *win)
{
    ...
    apply_theme(g_theme, win, title, body, accent);
}
