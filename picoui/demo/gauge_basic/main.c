...
static void make_ui(struct picoui_window *win)
{
    ...
    gauge = picoui_gauge_create_with_props((struct picoui_widget *)win, &props);

    picoui_label_set_text(title, "Gauge");
    picoui_widget_set_size((struct picoui_widget *)title, 220, 28);
    picoui_widget_set_size((struct picoui_widget *)gauge, 160, 160);
    picoui_widget_set_grid_cell((struct picoui_widget *)title, 0, 0, 1, 1, PICOUI_ALIGN_CENTER, PICOUI_ALIGN_CENTER);
    picoui_widget_set_grid_cell((struct picoui_widget *)gauge, 0, 1, 1, 1, PICOUI_ALIGN_CENTER, PICOUI_ALIGN_CENTER);
