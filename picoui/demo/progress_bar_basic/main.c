...
{
    if (theme == 0 || window == 0 || title == 0 || primary == 0 || secondary == 0) {
        return;
    }
    ...
    (void)picoui_theme_apply_to_widget(theme,
                                       ...
                                       PICOUI_STATE_DEFAULT);
    (void)picoui_theme_apply_to_widget(theme,
                                       (struct picoui_widget *)primary,
                                       PICOUI_PART_MAIN,
                                       PICOUI_STATE_DEFAULT);
    (void)picoui_theme_apply_to_widget(theme,
                                       (struct picoui_widget *)secondary,
                                       PICOUI_PART_MAIN,
                                       PICOUI_STATE_DEFAULT);
}
...
static void make_ui(struct picoui_window *win)
{
    ...
    picoui_widget_set_grid_cell((struct picoui_widget *)secondary,
                                ...
                                PICOUI_ALIGN_CENTER,
                                PICOUI_ALIGN_START);
    apply_theme(g_theme, win, title, primary, secondary);
}
