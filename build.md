...
## picoui
cmake --build build --target picoui_hello_world_demo && ./build/examples/sdl/picoui_hello_world_demo
...
## switch
 ...
 有 switch 的是这两个 demo：
  ...
  cmake --build build --target picoui_basic_widgets_demo && ./build/examples/sdl/picoui_basic_widgets_demo

  如果你想看更像设置页的场景，就跑：

  cmake --build build --target picoui_settings_panel_demo && ./build/examples/sdl/picoui_settings_panel_demo


   PICOUI_TOUCH_LOG=1 ./build/examples/sdl/picoui_basic_widgets_demo > 1.log 2>&1