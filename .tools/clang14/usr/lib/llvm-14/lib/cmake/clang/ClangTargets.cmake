...
get_filename_component(_realOrig "/usr/lib/llvm-14/lib/cmake/clang" REALPATH)
if(_realCurr STREQUAL _realOrig)
  set(_IMPORT_PREFIX "/usr/lib/llvm-14/lib/cmake/clang")
endif()
unset(_realOrig)
unset(_realCurr)
...
set_target_properties(clangAnalysisFlowSensitive PROPERTIES
  INTERFACE_LINK_LIBRARIES "clangAnalysis;clangAST;LLVM"
)
...
set_target_properties(clang-repl PROPERTIES
  INTERFACE_LINK_LIBRARIES "clang-cpp"
)
...
set_target_properties(clangDaemonTweaks PROPERTIES
  INTERFACE_LINK_LIBRARIES "clangAST;clangBasic;clangDaemon;clangdSupport;clangFormat;clangLex;clangToolingCore;clangToolingRefactoring;clangToolingSyntax;LLVM"
)

# Create imported target clangd
add_executable(clangd IMPORTED)

# Create imported target clangdRemoteIndexProto
add_library(clangdRemoteIndexProto STATIC IMPORTED)

set_target_properties(clangdRemoteIndexProto PROPERTIES
  INTERFACE_LINK_LIBRARIES "grpc++;protobuf;LLVM"
)

# Create imported target clangdMonitoringServiceProto
add_library(clangdMonitoringServiceProto STATIC IMPORTED)

set_target_properties(clangdMonitoringServiceProto PROPERTIES
  INTERFACE_LINK_LIBRARIES "grpc++;protobuf;LLVM"
)

# Create imported target clangdRemoteIndexServiceProto
add_library(clangdRemoteIndexServiceProto STATIC IMPORTED)

set_target_properties(clangdRemoteIndexServiceProto PROPERTIES
  INTERFACE_LINK_LIBRARIES "grpc++;protobuf;LLVM;\$<LINK_ONLY:clangdRemoteIndexProto>;\$<LINK_ONLY:clangdMonitoringServiceProto>"
)
...
set_target_properties(clangdRemoteIndex PROPERTIES
  INTERFACE_LINK_LIBRARIES "clangdRemoteIndexProto;clangdRemoteIndexServiceProto;clangdRemoteMarshalling;clangBasic;clangDaemon;clangdSupport;LLVM"
)

# Create imported target clangdRemoteMarshalling
add_library(clangdRemoteMarshalling STATIC IMPORTED)

set_target_properties(clangdRemoteMarshalling PROPERTIES
  INTERFACE_LINK_LIBRARIES "clangdRemoteIndexProto;clangDaemon;clangdSupport;LLVM"
)
