...
void picoui_message_box_set_on_confirm(struct picoui_message_box *box,
                                       picoui_message_box_callback_t callback,
                                       void *user_data);

void picoui_message_box_set_callback(struct picoui_message_box *box,
                                     picoui_message_box_callback_t callback,
                                     void *user_data);

void picoui_message_box_set_on_confirm_indexed(struct picoui_message_box *box,
