...
typedef struct {
    ...
    arm_2d_size_t flexBasisSize;
    arm_2d_size_t flexMinSize;
    arm_2d_size_t flexMaxSize;
    ...
    bool isHidden:1;
    bool hasFlexBasisSize:1;
    bool hasFlexMinWidth:1;
    bool hasFlexMinHeight:1;
    bool hasFlexMaxWidth:1;
