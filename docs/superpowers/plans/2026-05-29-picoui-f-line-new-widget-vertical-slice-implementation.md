...
- 新增: `picoui/include/picoui/list.h`
- 新增: `picoui/src/widgets/list.c`
- 新增: `picoui/src/backend/ldgui/backend_list.c`
- 新增: `picoui/demo/list_basic/main.c`
- 新增: `tests/picoui/unit/test_picoui_list.c`

### F 必要集成写面

- 修改: `picoui/include/picoui/picoui.h`
- 修改: `picoui/src/backend/ldgui/backend.h`
- 修改: `picoui/CMakeLists.txt` 或现有 PicoUI 源文件列表位置
- 修改: `examples/sdl/CMakeLists.txt`
- 修改: `tests/picoui/CMakeLists.txt`
- 修改: `tests/picoui/runtime/check_picoui_runtime.py`
...
- 修改: `docs/picoui-serial/F-线计划索引.md`
...
**文件:**
- Read: `docs/picoui-serial/F-线计划索引.md`
- Read: `docs/superpowers/specs/2026-05-29-picoui-f-line-new-widget-vertical-slice-design.md`

- [ ] **Step 1: 创建 worktree**

```bash
git worktree add .worktree/picoui-f-new-widgets HEAD
cd .worktree/picoui-f-new-widgets
...
创建 `picoui/include/picoui/list.h`，包含设计文档中的最小 API。不得出现 `ld*`、`arm_2d_*`、`SIGNAL_*`。

- [ ] **Step 2: 写 unit RED 测试**

创建 `test_picoui_list.c`，覆盖：
...
- 新增: `picoui/src/backend/ldgui/backend_list.c`
- 修改: `picoui/src/backend/ldgui/backend.h`
- 修改: PicoUI source list CMake file
- 修改: `picoui/include/picoui/picoui.h`
...
```text
gitnexus_impact(target="picoui_button_create", direction="upstream", repo="LingDongGUI")
gitnexus_impact(target="picoui_backend_create_button", direction="upstream", repo="LingDongGUI")
```
...
`picoui/demo/list_basic/main.c` 只能使用 `picoui_*` API。demo 内容：
...
在 `examples/sdl/CMakeLists.txt` 增加 `picoui_list_basic_demo`。
...
- 修改: `picoui/docs/demo_guide.md`
- 修改: `docs/picoui-serial/F-线计划索引.md`
- 修改: `docs/superpowers/specs/2026-05-29-picoui-f-line-new-widget-vertical-slice-design.md` 仅当 implementation exposes a documented reject/deferred item

- [ ] **Step 1: 更新 demo guide**

写清：

- `picoui_list_basic_demo` 的用途。
- 它证明哪些 gate。
...
```bash
git diff --check
rg -n "picoui_list|picoui_list_basic_demo|list_basic|multi-select|virtualization|keyboard navigation" \
  picoui/docs/demo_guide.md \
  docs/picoui-serial/F-线计划索引.md \
  docs/superpowers/specs/2026-05-29-picoui-f-line-new-widget-vertical-slice-design.md
```
