...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `ldCalloc` | `helper` | `internal_helper` | `memory_internal` | `false` | `allowlisted` | `non_widget_allowlisted` |  |  |  | R2 shared tree/helper/lifecycle API: internal backend structure or demo host helper, not a PicoUI user-facing native capability. 非 covered 行，不要求 PicoUI public/backend/unit 证据。 | `extern void *ldCalloc(uint32_t num,uint32_t size);` |
| 2 | `ldFree` | `helper` | `internal_helper` | `memory_internal` | `false` | `allowlisted` | `non_widget_allowlisted` |  |  |  | R2 shared tree/helper/lifecycle API: internal backend structure or demo host helper, not a PicoUI user-facing native capability. 非 covered 行，不要求 PicoUI public/backend/unit 证据。 | `extern void ldFree(void *p);` |
| 3 | `ldGetFreeMemory` | `helper` | `internal_helper` | `memory_internal` | `false` | `allowlisted` | `non_widget_allowlisted` |  |  |  | R2 shared tree/helper/lifecycle API: internal backend structure or demo host helper, not a PicoUI user-facing native capability. 非 covered 行，不要求 PicoUI public/backend/unit 证据。 | `extern size_t ldGetFreeMemory(void);` |
| 4 | `ldMalloc` | `helper` | `internal_helper` | `memory_internal` | `false` | `allowlisted` | `non_widget_allowlisted` |  |  |  | R2 shared tree/helper/lifecycle API: internal backend structure or demo host helper, not a PicoUI user-facing native capability. 非 covered 行，不要求 PicoUI public/backend/unit 证据。 | `extern void *ldMalloc(uint32_t size);` |
| 5 | `ldRealloc` | `helper` | `internal_helper` | `memory_internal` | `false` | `allowlisted` | `non_widget_allowlisted` |  |  |  | R2 shared tree/helper/lifecycle API: internal backend structure or demo host helper, not a PicoUI user-facing native capability. 非 covered 行，不要求 PicoUI public/backend/unit 证据。 | `extern void *ldRealloc(void *ptr,uint32_t newSize);` |
