...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `ldProgressWheelInit` | `macro_alias` | `widget` | `direct_covered` | `direct_public_covered` | `true` | `covered` | `shared_api_equivalence` | `tinyui_progress_wheel_init` | `tinyui_backend_create_progress_wheel` | test_progress_wheel_init_native_parity, ctest:test_tinyui_progress_wheel|test_tinyui_arc|test_tinyui_gauge | R5 third batch closed progress_wheel/arc/gauge rows with concrete TinyUI API or shared alias equivalence plus focused unit proof. 已校验：TinyUI API 字段在 public header 中存在；backend proof 当前为 ledger 证据标签，尚未被 checker 反查为真实 backend 符号或完整行为。 | `#define ldProgressWheelInit(nameId,parentNameId,x,y,width,height) ldProgressWheel_init(ptScene,NULL,nameId,parentNameId,x,y,width,height)` |
| 2 | `ldProgressWheelSetDotColor` | `setter` | `widget` | `direct_covered` | `direct_public_covered` | `true` | `covered` | `native_setter_parity` | `tinyui_progress_wheel_set_dot_color` | `tinyui_backend_progress_wheel_set_dot_color` | test_progress_wheel_set_dot_color_native_parity, ctest:test_tinyui_progress_wheel|test_tinyui_arc|test_tinyui_gauge | R5 third batch closed progress_wheel/arc/gauge rows with concrete TinyUI API or shared alias equivalence plus focused unit proof. 已校验：TinyUI API 字段在 public header 中存在；backend proof 当前为 ledger 证据标签，尚未被 checker 反查为真实 backend 符号或完整行为。 | `void ldProgressWheelSetDotColor(ldProgressWheel_t *ptWidget,ldColor dotColor,bool isEnable);` |
| 3 | `ldProgressWheelSetProgress` | `setter` | `widget` | `direct_covered` | `direct_public_covered` | `true` | `covered` | `native_setter_parity` | `tinyui_progress_wheel_set_progress` | `tinyui_backend_progress_wheel_set_progress` | test_progress_wheel_set_progress_native_parity, ctest:test_tinyui_progress_wheel|test_tinyui_arc|test_tinyui_gauge | R5 third batch closed progress_wheel/arc/gauge rows with concrete TinyUI API or shared alias equivalence plus focused unit proof. 已校验：TinyUI API 字段在 public header 中存在；backend proof 当前为 ledger 证据标签，尚未被 checker 反查为真实 backend 符号或完整行为。 | `void ldProgressWheelSetProgress(ldProgressWheel_t *ptWidget,int16_t value);` |
| 4 | `ldProgressWheelSetWheelColor` | `setter` | `widget` | `direct_covered` | `direct_public_covered` | `true` | `covered` | `native_setter_parity` | `tinyui_progress_wheel_set_wheel_color` | `tinyui_backend_progress_wheel_set_wheel_color` | test_progress_wheel_set_wheel_color_native_parity, ctest:test_tinyui_progress_wheel|test_tinyui_arc|test_tinyui_gauge | R5 third batch closed progress_wheel/arc/gauge rows with concrete TinyUI API or shared alias equivalence plus focused unit proof. 已校验：TinyUI API 字段在 public header 中存在；backend proof 当前为 ledger 证据标签，尚未被 checker 反查为真实 backend 符号或完整行为。 | `void ldProgressWheelSetWheelColor(ldProgressWheel_t *ptWidget,ldColor wheelColor);` |
| 5 | `ldProgressWheel_depose` | `lifecycle` | `widget` | `lifecycle_internal` | `policy_never_public` | `false` | `allowlisted` | `lifecycle_internal_allowlisted` |  |  |  | R2 shared tree/helper/lifecycle API: internal backend structure or demo host helper, not a TinyUI user-facing native capability. 非 covered 行，不要求 TinyUI public/backend/unit 证据。 | `void ldProgressWheel_depose(ld_scene_t *ptScene, ldProgressWheel_t *ptWidget);` |
| 6 | `ldProgressWheel_init` | `init` | `widget` | `direct_covered` | `direct_public_covered` | `true` | `covered` | `init_parameter_parity` | `tinyui_progress_wheel_init` | `tinyui_backend_create_progress_wheel` | test_progress_wheel_init_native_parity, ctest:test_tinyui_progress_wheel|test_tinyui_arc|test_tinyui_gauge | R5 third batch closed progress_wheel/arc/gauge rows with concrete TinyUI API or shared alias equivalence plus focused unit proof. 已校验：TinyUI API 字段在 public header 中存在；backend proof 当前为 ledger 证据标签，尚未被 checker 反查为真实 backend 符号或完整行为。 | `ldProgressWheel_t* ldProgressWheel_init(ld_scene_t *ptScene, ldProgressWheel_t *ptWidget, uint16_t nameId, uint16_t parentNameId, int16_t x, int16_t y, int16_t width, int16_t height);` |
| 7 | `ldProgressWheel_on_frame_complete` | `lifecycle` | `widget` | `lifecycle_internal` | `policy_never_public` | `false` | `allowlisted` | `lifecycle_internal_allowlisted` |  |  |  | R2 shared tree/helper/lifecycle API: internal backend structure or demo host helper, not a TinyUI user-facing native capability. 非 covered 行，不要求 TinyUI public/backend/unit 证据。 | `void ldProgressWheel_on_frame_complete(ld_scene_t *ptScene, ldProgressWheel_t *ptWidget);` |
| 8 | `ldProgressWheel_on_frame_start` | `lifecycle` | `widget` | `lifecycle_internal` | `policy_never_public` | `false` | `allowlisted` | `lifecycle_internal_allowlisted` |  |  |  | R2 shared tree/helper/lifecycle API: internal backend structure or demo host helper, not a TinyUI user-facing native capability. 非 covered 行，不要求 TinyUI public/backend/unit 证据。 | `void ldProgressWheel_on_frame_start(ld_scene_t *ptScene, ldProgressWheel_t *ptWidget);` |
| 9 | `ldProgressWheel_on_load` | `lifecycle` | `widget` | `lifecycle_internal` | `policy_never_public` | `false` | `allowlisted` | `lifecycle_internal_allowlisted` |  |  |  | R2 shared tree/helper/lifecycle API: internal backend structure or demo host helper, not a TinyUI user-facing native capability. 非 covered 行，不要求 TinyUI public/backend/unit 证据。 | `void ldProgressWheel_on_load(ld_scene_t *ptScene, ldProgressWheel_t *ptWidget);` |
| 10 | `ldProgressWheel_show` | `show` | `widget` | `render_pipeline_internal` | `policy_never_public` | `false` | `allowlisted` | `non_widget_allowlisted` |  |  |  | Render/show entry point owned by backend rendering pipeline. 非 covered 行，不要求 TinyUI public/backend/unit 证据。 | `void ldProgressWheel_show(ld_scene_t *pScene, ldProgressWheel_t *ptWidget, const arm_2d_tile_t *ptTile, bool bIsNewFrame);` |
