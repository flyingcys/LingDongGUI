...
2. 在当前主仓 `Darwin 25.5.0 (arm64) + cocoa + build/picoui-runtime` 环境下，上述 `24` 个 final release demo 都已生成可追溯 `frame.ppm` artifact。
3. 当前记录层级已覆盖：
...
rtk cmake --build build --target picoui_runtime
...
- SDL video driver：cocoa
- demo target：`picoui_hello_world_demo`
- 构建目录：`/Users/cys/embedded/LingDongGUI/build/picoui-runtime`
- 运行命令：`python3 tests/picoui/runtime/check_picoui_manual_window_artifact.py --demo hello_world`
- artifact 路径：`/Users/cys/embedded/LingDongGUI/artifacts/picoui/manual-window/hello_world/frame.ppm`
...
- 平台：Darwin 25.5.0 (arm64)
- SDL video driver：cocoa
- demo target：`picoui_layout_flex_demo`
- 构建目录：`/Users/cys/embedded/LingDongGUI/build/picoui-runtime`
- 运行命令：`python3 tests/picoui/runtime/check_picoui_manual_window_artifact.py --demo layout_flex`
- artifact 路径：`/Users/cys/embedded/LingDongGUI/artifacts/picoui/manual-window/layout_flex/frame.ppm`
...
- 平台：Darwin 25.5.0 (arm64)
- SDL video driver：cocoa
- demo target：`picoui_layout_grid_demo`
- 构建目录：`/Users/cys/embedded/LingDongGUI/build/picoui-runtime`
- 运行命令：`python3 tests/picoui/runtime/check_picoui_manual_window_artifact.py --demo layout_grid`
- artifact 路径：`/Users/cys/embedded/LingDongGUI/artifacts/picoui/manual-window/layout_grid/frame.ppm`
...
- 平台：Darwin 25.5.0 (arm64)
- SDL video driver：cocoa
- demo target：`picoui_theme_showcase_demo`
- 构建目录：`/Users/cys/embedded/LingDongGUI/build/picoui-runtime`
- 运行命令：`python3 tests/picoui/runtime/check_picoui_manual_window_artifact.py --demo theme_showcase`
- artifact 路径：`/Users/cys/embedded/LingDongGUI/artifacts/picoui/manual-window/theme_showcase/frame.ppm`
...
- 平台：Darwin 25.5.0 (arm64)
- SDL video driver：cocoa
- demo target：`picoui_list_basic_demo`
- 构建目录：`/Users/cys/embedded/LingDongGUI/build/picoui-runtime`
- 运行命令：`python3 tests/picoui/runtime/check_picoui_manual_window_artifact.py --demo list_basic`
- artifact 路径：`/Users/cys/embedded/LingDongGUI/artifacts/picoui/manual-window/list_basic/frame.ppm`
...
- 平台：Darwin 25.5.0 (arm64)
- SDL video driver：cocoa
- demo target：`picoui_progress_bar_basic_demo`
- 构建目录：`/Users/cys/embedded/LingDongGUI/build/picoui-runtime`
- 运行命令：`python3 tests/picoui/runtime/check_picoui_manual_window_artifact.py --demo progress_bar_basic`
- artifact 路径：`/Users/cys/embedded/LingDongGUI/artifacts/picoui/manual-window/progress_bar_basic/frame.ppm`
...
- 平台：Darwin 25.5.0 (arm64)
- SDL video driver：cocoa
- demo target：`picoui_arc_basic_demo`
- 构建目录：`/Users/cys/embedded/LingDongGUI/build/picoui-runtime`
- 运行命令：`python3 tests/picoui/runtime/check_picoui_manual_window_artifact.py --demo arc_basic`
- artifact 路径：`/Users/cys/embedded/LingDongGUI/artifacts/picoui/manual-window/arc_basic/frame.ppm`
...
- 平台：Darwin 25.5.0 (arm64)
- SDL video driver：cocoa
- demo target：`picoui_gauge_basic_demo`
- 构建目录：`/Users/cys/embedded/LingDongGUI/build/picoui-runtime`
- 运行命令：`python3 tests/picoui/runtime/check_picoui_manual_window_artifact.py --demo gauge_basic`
- artifact 路径：`/Users/cys/embedded/LingDongGUI/artifacts/picoui/manual-window/gauge_basic/frame.ppm`
...
- 平台：Darwin 25.5.0 (arm64)
- SDL video driver：cocoa
- demo target：`picoui_icon_slider_basic_demo`
- 构建目录：`/Users/cys/embedded/LingDongGUI/build/picoui-runtime`
- 运行命令：`python3 tests/picoui/runtime/check_picoui_manual_window_artifact.py --demo icon_slider_basic`
- artifact 路径：`/Users/cys/embedded/LingDongGUI/artifacts/picoui/manual-window/icon_slider_basic/frame.ppm`
...
- 平台：Darwin 25.5.0 (arm64)
- SDL video driver：cocoa
- demo target：`picoui_radial_menu_basic_demo`
- 构建目录：`/Users/cys/embedded/LingDongGUI/build/picoui-runtime`
- 运行命令：`python3 tests/picoui/runtime/check_picoui_manual_window_artifact.py --demo radial_menu_basic`
- artifact 路径：`/Users/cys/embedded/LingDongGUI/artifacts/picoui/manual-window/radial_menu_basic/frame.ppm`
...
- 平台：Darwin 25.5.0 (arm64)
- SDL video driver：cocoa
- demo target：`picoui_progress_wheel_basic_demo`
- 构建目录：`/Users/cys/embedded/LingDongGUI/build/picoui-runtime`
- 运行命令：`python3 tests/picoui/runtime/check_picoui_manual_window_artifact.py --demo progress_wheel_basic`
- artifact 路径：`/Users/cys/embedded/LingDongGUI/artifacts/picoui/manual-window/progress_wheel_basic/frame.ppm`
...
- 平台：Darwin 25.5.0 (arm64)
- SDL video driver：cocoa
- demo target：`picoui_qrcode_basic_demo`
- 构建目录：`/Users/cys/embedded/LingDongGUI/build/picoui-runtime`
- 运行命令：`python3 tests/picoui/runtime/check_picoui_manual_window_artifact.py --demo qrcode_basic`
- artifact 路径：`/Users/cys/embedded/LingDongGUI/artifacts/picoui/manual-window/qrcode_basic/frame.ppm`
...
- 平台：Darwin 25.5.0 (arm64)
- SDL video driver：cocoa
- demo target：`picoui_message_box_basic_demo`
- 构建目录：`/Users/cys/embedded/LingDongGUI/build/picoui-runtime`
- 运行命令：`python3 tests/picoui/runtime/check_picoui_manual_window_artifact.py --demo message_box_basic`
- artifact 路径：`/Users/cys/embedded/LingDongGUI/artifacts/picoui/manual-window/message_box_basic/frame.ppm`
...
- 平台：Darwin 25.5.0 (arm64)
- SDL video driver：cocoa
- demo target：`picoui_date_time_basic_demo`
- 构建目录：`/Users/cys/embedded/LingDongGUI/build/picoui-runtime`
- 运行命令：`python3 tests/picoui/runtime/check_picoui_manual_window_artifact.py --demo date_time_basic`
- artifact 路径：`/Users/cys/embedded/LingDongGUI/artifacts/picoui/manual-window/date_time_basic/frame.ppm`
...
- 平台：Darwin 25.5.0 (arm64)
- SDL video driver：cocoa
- demo target：`picoui_clock_basic_demo`
- 构建目录：`/Users/cys/embedded/LingDongGUI/build/picoui-runtime`
- 运行命令：`python3 tests/picoui/runtime/check_picoui_manual_window_artifact.py --demo clock_basic`
- artifact 路径：`/Users/cys/embedded/LingDongGUI/artifacts/picoui/manual-window/clock_basic/frame.ppm`
...
- 平台：Darwin 25.5.0 (arm64)
- SDL video driver：cocoa
- demo target：`picoui_keyboard_basic_demo`
- 构建目录：`/Users/cys/embedded/LingDongGUI/build/picoui-runtime`
- 运行命令：`python3 tests/picoui/runtime/check_picoui_manual_window_artifact.py --demo keyboard_basic`
- artifact 路径：`/Users/cys/embedded/LingDongGUI/artifacts/picoui/manual-window/keyboard_basic/frame.ppm`
...
- 平台：Darwin 25.5.0 (arm64)
- SDL video driver：cocoa
- demo target：`picoui_line_edit_basic_demo`
- 构建目录：`/Users/cys/embedded/LingDongGUI/build/picoui-runtime`
- 运行命令：`python3 tests/picoui/runtime/check_picoui_manual_window_artifact.py --demo line_edit_basic`
- artifact 路径：`/Users/cys/embedded/LingDongGUI/artifacts/picoui/manual-window/line_edit_basic/frame.ppm`
...
- 平台：Darwin 25.5.0 (arm64)
- SDL video driver：cocoa
- demo target：`picoui_combo_box_basic_demo`
- 构建目录：`/Users/cys/embedded/LingDongGUI/build/picoui-runtime`
- 运行命令：`python3 tests/picoui/runtime/check_picoui_manual_window_artifact.py --demo combo_box_basic`
- artifact 路径：`/Users/cys/embedded/LingDongGUI/artifacts/picoui/manual-window/combo_box_basic/frame.ppm`
...
- 平台：Darwin 25.5.0 (arm64)
- SDL video driver：cocoa
- demo target：`picoui_scroll_selecter_basic_demo`
- 构建目录：`/Users/cys/embedded/LingDongGUI/build/picoui-runtime`
- 运行命令：`python3 tests/picoui/runtime/check_picoui_manual_window_artifact.py --demo scroll_selecter_basic`
- artifact 路径：`/Users/cys/embedded/LingDongGUI/artifacts/picoui/manual-window/scroll_selecter_basic/frame.ppm`
...
- 平台：Darwin 25.5.0 (arm64)
- SDL video driver：cocoa
- demo target：`picoui_table_basic_demo`
- 构建目录：`/Users/cys/embedded/LingDongGUI/build/picoui-runtime`
- 运行命令：`python3 tests/picoui/runtime/check_picoui_manual_window_artifact.py --demo table_basic`
- artifact 路径：`/Users/cys/embedded/LingDongGUI/artifacts/picoui/manual-window/table_basic/frame.ppm`
...
- 平台：Darwin 25.5.0 (arm64)
- SDL video driver：cocoa
- demo target：`picoui_graph_basic_demo`
- 构建目录：`/Users/cys/embedded/LingDongGUI/build/picoui-runtime`
- 运行命令：`python3 tests/picoui/runtime/check_picoui_manual_window_artifact.py --demo graph_basic`
- artifact 路径：`/Users/cys/embedded/LingDongGUI/artifacts/picoui/manual-window/graph_basic/frame.ppm`
...
- 平台：Darwin 25.5.0 (arm64)
- SDL video driver：cocoa
- demo target：`picoui_calendar_basic_demo`
- 构建目录：`/Users/cys/embedded/LingDongGUI/build/picoui-runtime`
- 运行命令：`python3 tests/picoui/runtime/check_picoui_manual_window_artifact.py --demo calendar_basic`
- artifact 路径：`/Users/cys/embedded/LingDongGUI/artifacts/picoui/manual-window/calendar_basic/frame.ppm`
