...
This project is indexed by GitNexus as **LingDongGUI** (118188 symbols, 172900 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
