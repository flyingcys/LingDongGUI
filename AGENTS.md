...
This project is indexed by GitNexus as **LingDongGUI** (119867 symbols, 155482 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
