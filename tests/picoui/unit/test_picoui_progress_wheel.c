...
__attribute__((weak)) void picoui_backend_progress_wheel_test_reset_state(void)
{
}

__attribute__((weak)) void picoui_backend_progress_wheel_test_fail_next_set_percent(void)
{
}

__attribute__((weak)) int picoui_backend_progress_wheel_test_take_last_dispose_snapshot(
...
static void test_progress_wheel_create_and_backend_mapping(struct picoui_window *win)
{
    ...
    assert(picoui_widget_has_ld_binding(&wheel->widget) == 1);
}
    ...
    struct picoui_window *win)
{
    ...
    struct picoui_progress_wheel_test_dispose_snapshot snapshot = {0};
    ...
    picoui_backend_progress_wheel_test_reset_state();
    ...
    picoui_backend_progress_wheel_test_fail_next_set_percent();
    ...
    assert(picoui_backend_progress_wheel_test_take_last_dispose_snapshot(&snapshot) == 0);
    ...
    assert(picoui_backend_progress_wheel_test_take_last_dispose_snapshot(&snapshot) == -1);
    if (tail != 0) {
