/*
 * M3 Task 10 dedicated evidence runner for selection_collection.
 */
...
int main(int argc, char **argv)
{
    ...
    tinyui_demo_v23_selection_collection();
    ...
    for (;;) {
        ...
        tinyui_demo_v23_selection_collection_frame(elapsed_ms);
