/*
 * M2 Task 8 dedicated evidence runner.
 * Avoids compiling the full pre-M4 demo tree (old create signatures).
 */
...
/* Frame step with quit semantics; public tinyui_process() swallows step>0. */
...
int main(int argc, char **argv)
{
    ...
    for (;;) {
        ...
        tinyui_demo_v23_core_vertical_frame(elapsed_ms);
