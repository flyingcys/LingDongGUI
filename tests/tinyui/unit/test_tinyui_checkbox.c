...
static void test_checkbox_internal_seams_use_tinyui_prefix(void)
{
    ...
    assert_source_lacks_text(source_path, "picoui_checkbox_fail_next_set_check_color");
    assert_source_lacks_text(source_path, "picoui_checkbox_rgb_to_ld_color");
    assert_source_lacks_text(source_path, "picoui_checkbox_get_ld");
    assert_source_lacks_text(source_path, "picoui_checkbox_props_are_valid");
    assert_source_lacks_text(source_path, "picoui_checkbox_dispose_partial");
    assert_source_lacks_text(source_path, "picoui_backend_checkbox_test_fail_next_set_check_color");
