...
static void test_progress_bar_create_and_backend_mapping(struct picoui_window *win)
{
    const char *progress_bar_widget_source_path =
        picoui_test_repo_path_from_file(__FILE__, "tinyui/src/widgets/progress_bar.c");
    ...
    assert(picoui_test_source_contains(progress_bar_widget_source_path,
                                       "tinyui_progress_bar_test_create_with_props_fail_before_inverted") == 1);
    assert(picoui_test_source_contains(progress_bar_widget_source_path,
                                       "tinyui_progress_bar_create_with_props_impl") == 1);
    assert(picoui_test_source_contains(progress_bar_widget_source_path,
                                       "picoui_backend_progress_bar_test_create_with_props_fail_before_inverted") == 0);
    assert(picoui_test_source_contains(progress_bar_widget_source_path,
                                       "picoui_progress_bar_create_with_props_impl") == 0);
}
