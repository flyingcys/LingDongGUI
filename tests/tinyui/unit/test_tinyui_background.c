...
static void test_background_widget_file_owns_internal_helper_truth(void)
{
    ...
    assert_source_lacks_symbol_definition(source_path, "picoui_background_backend_host");
    assert_source_lacks_symbol_definition(source_path, "picoui_background_get_root_size");
