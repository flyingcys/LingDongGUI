...
static void test_graph_internal_seams_use_tinyui_prefix(void)
{
    ...
    assert_source_lacks_function_definition(widget_path, "picoui_graph_backend");
    assert_source_lacks_function_definition(widget_path, "picoui_graph_backend_const");
    assert_source_lacks_function_definition(widget_path, "picoui_graph_get_ld");
    assert_source_lacks_function_definition(widget_path, "picoui_graph_get_ld_const");
    assert_source_lacks_function_definition(widget_path, "picoui_graph_props_are_valid");
    assert_source_lacks_function_definition(widget_path, "picoui_graph_apply_native_geometry_candidate");

    assert_source_has_function_definition(widget_path, "static struct picoui_backend_widget *", "tinyui_graph_backend");
    assert_source_has_function_definition(widget_path, "static struct picoui_backend_widget *", "tinyui_graph_backend_const");
