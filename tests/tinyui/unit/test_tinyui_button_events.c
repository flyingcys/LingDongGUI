...
static void test_event_shared_helpers_use_tinyui_prefix_in_core_seam(void)
{
    ...
    assert_self_binary_lacks_symbol("picoui_widget_sync_ld_value");
    assert_self_binary_lacks_symbol("picoui_widget_emit_ld_event_bridge");
}
...
static void test_dispatch_entries_use_tinyui_prefix_in_core_seam(void)
{
    ...
    assert_self_binary_lacks_symbol("picoui_widget_dispatch_signal");
    assert_self_binary_lacks_symbol("picoui_widget_dispatch_event");
}
...
static void test_button_internal_seams_use_tinyui_prefix(void)
{
    ...
    assert_self_binary_lacks_symbol("picoui_button_get_ld");
    assert_self_binary_lacks_symbol("picoui_button_default_font");
    assert_self_binary_lacks_symbol("picoui_button_resolve_font");
    assert_self_binary_lacks_symbol("picoui_button_alloc");
    assert_self_binary_lacks_symbol("picoui_button_set_event");
    assert_self_binary_lacks_symbol("picoui_button_dispose_partial");
    assert_self_binary_lacks_symbol("picoui_button_props_are_valid");
    assert_self_binary_lacks_symbol("picoui_backend_button_test_fail_next_set_font");
}
