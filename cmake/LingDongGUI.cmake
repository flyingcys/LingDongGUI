...
function(ld_define_core_targets)
    ...
    add_library(picoui_core STATIC
        ...
        ${LD_REPO_ROOT}/picoui/src/native/native_arc.c
        ${LD_REPO_ROOT}/picoui/src/native/native_gauge.c
        ${LD_REPO_ROOT}/picoui/src/native/native_calendar.c
        ${LD_REPO_ROOT}/picoui/src/native/native_clock.c
        ${LD_REPO_ROOT}/picoui/src/native/native_combo_box.c
        ${LD_REPO_ROOT}/picoui/src/native/native_date_time.c
        ${LD_REPO_ROOT}/picoui/src/native/native_graph.c
        ${LD_REPO_ROOT}/picoui/src/native/native_progress_bar.c
        ${LD_REPO_ROOT}/picoui/src/native/native_progress_wheel.c
        ${LD_REPO_ROOT}/picoui/src/native/native_qrcode.c
        ${LD_REPO_ROOT}/picoui/src/native/native_qrcode_renderer.c
        ${LD_REPO_ROOT}/picoui/src/native/native_radial_menu.c
        ${LD_REPO_ROOT}/picoui/src/native/native_scroll_selecter.c
        ${LD_REPO_ROOT}/picoui/src/native/native_table.c
        ${LD_REPO_ROOT}/picoui/src/native/native_animation.c
        ${LD_REPO_ROOT}/picoui/src/native/native_canvas.c
        ${LD_REPO_ROOT}/picoui/src/native/native_canvas_renderer.c
        ${LD_REPO_ROOT}/picoui/src/native/native_resource.c
        ${LD_REPO_ROOT}/picoui/src/native/native_text_renderer.c
        ${LD_REPO_ROOT}/picoui/src/native/native_text.c
        ${LD_REPO_ROOT}/picoui/src/native/native_keyboard.c
        ${LD_REPO_ROOT}/picoui/src/native/native_line_edit.c
        ${LD_REPO_ROOT}/picoui/src/native/native_image_renderer.c
        ...
        ${LD_REPO_ROOT}/picoui/src/native/native_message_box.c
        ${LD_REPO_ROOT}/picoui/src/native/native_icon_slider.c
    ...
    target_link_libraries(ld_picoui_native_runtime_support PUBLIC
        picoui_core
        longdonggui
        longdonggui_porting_default
    )
    ld_apply_picoui_runtime_screen_config(ld_picoui_native_runtime_support)
    if(WIN32)
        ...
        target_include_directories(ld_picoui_native_runtime_support PUBLIC "${LD_SDL2_ROOT}/include/SDL2")
        target_link_directories(ld_picoui_native_runtime_support PUBLIC "${LD_SDL2_ROOT}/lib")
        target_link_libraries(ld_picoui_native_runtime_support PUBLIC SDL2 SDL2main)
    else()
        find_package(PkgConfig REQUIRED)
        pkg_check_modules(SDL2 REQUIRED sdl2)
        target_include_directories(ld_picoui_native_runtime_support PUBLIC ${SDL2_INCLUDE_DIRS})
        target_link_directories(ld_picoui_native_runtime_support PUBLIC ${SDL2_LIBRARY_DIRS})
        target_compile_options(ld_picoui_native_runtime_support PRIVATE ${SDL2_CFLAGS_OTHER})
        target_link_options(ld_picoui_native_runtime_support PRIVATE ${SDL2_LDFLAGS_OTHER})
        target_link_libraries(ld_picoui_native_runtime_support PUBLIC ${SDL2_LIBRARIES})
    endif()
    ld_apply_common_target_config(ld_picoui_native_runtime_support)

    add_library(picoui_native_arm2d INTERFACE)
    target_link_libraries(picoui_native_arm2d INTERFACE
        picoui_core
        ld_picoui_native_runtime_support
    )
    add_library(picoui ALIAS picoui_native_arm2d)

    if(PICOUI_ENABLE_LEGACY_LDGUI)
        ...
        endforeach()
        add_library(picoui_legacy_ldgui ALIAS picoui_backend_ldgui)
        add_library(picoui_legacy_ldgui_runtime ALIAS picoui_backend_ldgui_runtime)
    endif()
